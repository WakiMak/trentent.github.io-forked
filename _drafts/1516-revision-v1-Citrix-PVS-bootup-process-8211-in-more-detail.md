---
id: 1564
title: 'Citrix PVS bootup process &#8211; in more detail'
date: 2016-06-28T16:13:22-06:00
author: trententtye
layout: revision
...
Our time spent reading the VHD/file is ~1.5 seconds so I don&#8217;t think we can speed up reading the vDisk file. Â But we can improve our network speed. Â The UDP packets are only 1458B in length because we are stuck due to the MTU size (1500). Â We should be able to increase this to Jumbo Frames which should reduce the amount of times we send data over the wire. Â For some reason, it appears we read alot of data from the SMB at MTU length. Â This probably reduces our performance when reading large chunks of sequential data.
