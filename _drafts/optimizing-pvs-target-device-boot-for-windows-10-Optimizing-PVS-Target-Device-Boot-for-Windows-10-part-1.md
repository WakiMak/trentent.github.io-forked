...
date: 2017-01-02T14:14:35-06:00
author: trententtye
layout: post
guid: http://theorypc.ca/?p=1828
permalink: /?p=1828
categories:
  - Blog
---
...
bnistack6.sys takes 3.6 seconds. Â There doesn&#8217;t appear to be anyways to reduce this. Â At a minimum, using PVS will add 3.0+ seconds to your boot time at a minimum. Â <span style="text-decoration: underline;">At least with EFI boot.</span>

So what&#8217;s next? Â Looking at the boot graph in Windows Performance Analyzer again, we can see that we have a 4 second Pre Session Init with 3.6 seconds being consumed by the BNIStack6.sys driver.

<img class="aligncenter size-full wp-image-2013" src="http://theorypc.ca/wp-content/uploads/2017/01/Pre-sessionInit.png" alt="" width="1116" height="696" srcset="http://theorypc.ca/wp-content/uploads/2017/01/Pre-sessionInit.png 1116w, http://theorypc.ca/wp-content/uploads/2017/01/Pre-sessionInit-300x187.png 300w, http://theorypc.ca/wp-content/uploads/2017/01/Pre-sessionInit-768x479.png 768w" sizes="(max-width: 1116px) 100vw, 1116px" /> 

&nbsp;

So we need to find the next time killers and see what we can do about removing them from the picture.

I&#8217;ve zoomed on &#8216;Session Init&#8217; and added the &#8220;Generic Events&#8221; view. Â I like this view because each dot equals some form of activity and it makes it relatively obvious which components are consuming time:

<img class="aligncenter size-full wp-image-2014" src="http://theorypc.ca/wp-content/uploads/2017/01/SessionInit.png" alt="" width="1106" height="554" srcset="http://theorypc.ca/wp-content/uploads/2017/01/SessionInit.png 1106w, http://theorypc.ca/wp-content/uploads/2017/01/SessionInit-300x150.png 300w, http://theorypc.ca/wp-content/uploads/2017/01/SessionInit-768x385.png 768w" sizes="(max-width: 1106px) 100vw, 1106px" /> 

&nbsp;

In this case, Microsoft-Windows-CodeIntegrity is consuming a significant portion of this time. Â Is this something we can disable or prevent from operating?

I also came across this key/value and it intrigued me.

<img class="aligncenter size-full wp-image-2016" src="http://theorypc.ca/wp-content/uploads/2017/01/DisableWpbtExecution.png" alt="" width="1151" height="908" srcset="http://theorypc.ca/wp-content/uploads/2017/01/DisableWpbtExecution.png 1151w, http://theorypc.ca/wp-content/uploads/2017/01/DisableWpbtExecution-300x237.png 300w, http://theorypc.ca/wp-content/uploads/2017/01/DisableWpbtExecution-768x606.png 768w" sizes="(max-width: 1151px) 100vw, 1151px" /> 

Anything I can disable from running within the VDI that&#8217;s not applicable is a win in my book.

DisableWpbtExecution

What is this value? Â [WPBT](http://download.microsoft.com/download/8/a/2/8a2fb72d-9b96-4e2d-a559-4a27cf905a80/windows-platform-binary-table.docx) (Windows Platform Binary Table) is a tool for OEM&#8217;s to use to store an executable in the BIOS that Windows will extract and run on boot. Â [Lenovo got into hot water](https://senk9.wordpress.com/2015/08/19/the-windows-platform-binary-table-and-you/) over this feature because they used it for some software that appeared to have &#8220;mysterious&#8221; purposes.

Would this be needed in a VDI environment? Â Most certaintly not! Â I set the value as a DWORD and set it to 0x1.

<img class="aligncenter size-full wp-image-2017" src="http://theorypc.ca/wp-content/uploads/2017/01/DisableWpbtExecution_reg.png" alt="" width="1042" height="728" srcset="http://theorypc.ca/wp-content/uploads/2017/01/DisableWpbtExecution_reg.png 1042w, http://theorypc.ca/wp-content/uploads/2017/01/DisableWpbtExecution_reg-300x210.png 300w, http://theorypc.ca/wp-content/uploads/2017/01/DisableWpbtExecution_reg-768x537.png 768w" sizes="(max-width: 1042px) 100vw, 1042px" /> 

I don&#8217;t know if these values are appropriate, but I&#8217;m hoping they are. Â I don&#8217;t have another system (like a Lenovo) to test to validate it does anything. Â ðŸ™‚

Another boot process we shouldn&#8217;t need for PVS images is Windows Defendor ELAM (Early Launch AntiMalware). Â This is probably more relevant to a desktop or something where the disk is malleable. Â As long as you secure your environment for your PVS image updates you should be safe&#8230;

(set WDBOOT & WDFILTER START =0x4)

disable crashdump

HKEY\_LOCAL\_MACHINE\SYSTEM\CurrentControlSet\Control\CrashControl

DWORD:CrashDumpEnabled:0x0

PEAuth is the code integrity checker &#8220;Protected Environment Authentication and Authorization Export Driver&#8221; (?)

Service set to disabled 0x4 (or delete?!)
