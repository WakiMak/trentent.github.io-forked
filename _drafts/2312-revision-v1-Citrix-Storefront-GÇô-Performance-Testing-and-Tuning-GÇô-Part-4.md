---
id: 2349
title: Citrix Storefront â€“ Performance Testing and Tuning â€“ Part 4
date: 2017-05-26T21:42:29-06:00
author: trententtye
layout: revision
guid: http://theorypc.ca/2017/05/26/2312-revision-v1/
permalink: /2017/05/26/2312-revision-v1/
---
[In part 1](https://theorypc.ca/2017/05/24/citrix-storefront-performance-testing-and-tuning-part-1/), I went through and developed a script that will simulate a user logon and launching an application through Storefront. Â This post will go through testing the limits of Storefront on aÂ XenApp infrastructure. Â What I&#8217;m curious to know is how many simultaneous users can we have accessing Storefront before we start to experience performance problems. Â I tested with a user account that I consider extreme &#8212; 376 published applications assigned to it with ~180 unique icons. Â My thoughts are this would push &#8216;resource enumeration&#8217; fairly high as each assigned application needs to evaluate to TRUE for this user.
...
<img class="aligncenter size-full wp-image-2324" src="http://theorypc.ca/wp-content/uploads/2017/05/Screen-Shot-2017-05-24-at-10.03.59-PM.png" alt="" width="1248" height="499" srcset="http://theorypc.ca/wp-content/uploads/2017/05/Screen-Shot-2017-05-24-at-10.03.59-PM.png 1248w, http://theorypc.ca/wp-content/uploads/2017/05/Screen-Shot-2017-05-24-at-10.03.59-PM-300x120.png 300w, http://theorypc.ca/wp-content/uploads/2017/05/Screen-Shot-2017-05-24-at-10.03.59-PM-768x307.png 768w" sizes="(max-width: 1248px) 100vw, 1248px" /> 

&nbsp;

Now, I noticed something a bit unfortunate with my Storefront server. Â It was using the &#8220;[LSI Logic SAS&#8221; controller instead of the &#8220;VMWare Paravirtual](https://blogs.vmware.com/vsphere/2014/02/vscsi-controller-choose-performance.html)&#8221; controller. Â Since we seem to be getting CPU bound, I changed the controller and reran the 4vCPU test:
