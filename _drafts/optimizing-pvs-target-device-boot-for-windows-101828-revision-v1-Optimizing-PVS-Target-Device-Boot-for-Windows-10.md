---
id: 2009
title: Optimizing PVS Target Device Boot for Windows 10
date: 2017-02-02T13:53:24-06:00
author: trententtye
layout: revision
guid: http://theorypc.ca/2017/02/02/1828-revision-v1/
permalink: /2017/02/02/1828-revision-v1/
---
...
I&#8217;m going to start with Hyper-V since I&#8217;m using VMWare. Â I found some Hyper-V features are enabled by default:
...
Removing them can be done with this command line:  
dism /online /disable-feature /featureName:Microsoft-Hyper-V-Common-Drivers-Package

dism /online /disable-feature /featureName:Microsoft-Hyper-V-Guest-Integration-Drivers-Package

And reboot. Â It appears the HVService isn&#8217;t set as a boot service though, so I don&#8217;t think this will have any impact&#8230;? Â The documentation states ANY driver that has a callback routine will execute. Â But if the driver is disabled will it?
...
<img class="aligncenter size-full wp-image-1872" src="http://theorypc.ca/wp-content/uploads/2016/12/PVS_Commands.png" alt="" width="1483" height="484" srcset="http://theorypc.ca/wp-content/uploads/2016/12/PVS_Commands.png 1483w, http://theorypc.ca/wp-content/uploads/2016/12/PVS_Commands-300x98.png 300w, http://theorypc.ca/wp-content/uploads/2016/12/PVS_Commands-768x251.png 768w" sizes="(max-width: 1483px) 100vw, 1483px" /> 

<pre class="lang:default decode:true ">EXEC [dbo].[uspSetServerStatusContactInfo]     @serverId = '7fb9f8b4-6598-4737-9597-ea24738b8e93',     @ip = 176465344,     @port = 6910,     @deviceCount = 1,     @powerRating = 1.000000,     @siteId = '2f92df61-8f88-43aa-a2bf-c4ba48bf7942',     @serverCacheTimeout = 8 
EXEC [dbo].[uspGetAllServerContactInfoRev1] 
</pre>
...
SQL has no problems executing any of these queries in just a few milliseconds. So SQL is operating fast and properly.
...
bnistack6.sys takes 3.6 seconds. Â There doesn&#8217;t appear to be anyways to reduce this. Â At a minimum, using PVS will add 3.6+ seconds to your boot time.
