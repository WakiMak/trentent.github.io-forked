...
It appears this issue is caused by & because it modifies the Internet Explorer handler registry keys to point to a unique Citrix version of IE.Â This version appears to open outside the bubble.Â to correct this you need to change these registry keys:
