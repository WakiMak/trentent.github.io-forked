...
Packet 9295 to 9413 = 6 seconds (2*3
```
...
```plaintext
With 100ms Initial RTO we see the difference between the packets to be:
...
Packet 39693 to 39754 = 600ms (2*3
```
