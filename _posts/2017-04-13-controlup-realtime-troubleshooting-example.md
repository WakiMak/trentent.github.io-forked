...
[Youtube link. Â Please ensure to select the highest quality.](https://youtu.be/hDC2iNoLoME)

Without ControlUp, trying to search all the servers was a manual task or a scripted task that was executed serially. Â These tasks, in the past, would take tons of time. Â Generally, an issue like this would have taken an hour or so to resolve. Â With ControlUp this was resolved in less than 5 minutes.
