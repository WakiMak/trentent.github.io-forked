...
---
Part one: [Citrix Workspace Environment Manager - First Impressions](https://theorypc.ca/2017/03/02/citrix-workspace-environment-manager-first-impressions/)  
...
Total time: <span style="text-decoration: underline;"><strong>3605ms</strong></span>.
