...
* On new logins the registry hive is copied from Default User to your profile directory, the hive is mounted and than security permissions are set.  
![](/wp-content/uploads/2018/06/Screen-Shot-2018-06-30-at-2.26.50-PM.png)
...
* The Profile Notification system now kicks off.  
![](/wp-content/uploads/2018/06/Screen-Shot-2018-06-30-at-2.39.10-PM.png)
...
![](/wp-content/uploads/2018/06/Screen-Shot-2018-06-30-at-2.45.44-PM.png)

It also appears we can measure the duration of each module by the "RegOpenKey" and "RegCloseKey" events tied to that module.  
![](/wp-content/uploads/2018/06/Screen-Shot-2018-06-30-at-2.48.23-PM.png)
...
![](/wp-content/uploads/2018/06/Screen-Shot-2018-06-30-at-3.06.45-PM.png)

* In the previous screenshot we can see the ProfileNotification has two events kicked off that it runs through it's list of modules: Create and Load.  Load takes 153ms in total, so Create is what is triggering our event.
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Can you set the FTA in the XML file for defaults to keep things at a minimum? Then use SetUserFTA from <a href="https://twitter.com/_kolbicz?ref_src=twsrc%5Etfw">@_kolbicz</a> to script your specific needs after login?</p>&mdash; Steve Elgan (@selgan) <a href="https://twitter.com/selgan/status/1011443091503505408?ref_src=twsrc%5Etfw">June 26, 2018</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
Lastly, time is _**still**_ being consumed on RDS and server platforms by the infuriating <span style="text-decoration: underline;"><strong>garbage</strong></span> services like GamesUX ("Games Explorer").  It just tweaks a nerve a little bit when I see time being consumed on wasteful processes.
